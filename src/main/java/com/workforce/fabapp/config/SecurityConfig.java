    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/employees", "/api/admin/users").hasAnyRole("ADMIN", "PAYROLL")
                        .requestMatchers("/api/admin/payroll-review/**").hasAnyRole("ADMIN", "PAYROLL")
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers("/api/payroll/**").hasAnyRole("ADMIN", "PAYROLL")
                        .requestMatchers("/api/history/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/system/holidays").hasAnyRole("ADMIN", "PAYROLL")
                        .requestMatchers("/api/system/**").hasRole("ADMIN")
                        .requestMatchers("/api/approvals/**").hasAnyRole("SUPERVISOR", "ADMIN", "PAYROLL")
                        .requestMatchers("/api/supervisors/**").hasAnyRole("SUPERVISOR", "ADMIN")
                        .requestMatchers("/api/double-time/**").hasAnyRole("SUPERVISOR", "ADMIN", "PAYROLL")
